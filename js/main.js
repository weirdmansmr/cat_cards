function card1_2(num) {
  let card_main;
  let card;
  const card_top_text = document.getElementsByClassName("card_text1")[num];
  const card_bottom = document.getElementsByClassName("text")[num];
  const card_corner = document.getElementsByClassName("corner")[num];
  const card_circle = document.getElementsByClassName("card_text5")[num];
  const button = document.getElementsByClassName("buy")[num];

  if (num == 0) {
    card_main = document.getElementsByClassName("container__1")[0];
    card = document.getElementsByClassName("card_1")[0];
  } else if (num == 1) {
    card_main = document.getElementsByClassName("container__2")[0];
    card = document.getElementsByClassName("card_2")[0];
  }
